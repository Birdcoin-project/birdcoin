...
uint256 hashGenesisBlock("0xca8373a8f0e8e5814904b530a5c32d7f4a7ea48341029109289d7b02dba0db73");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Birdcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Birdcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 60 * 60;	// Birdcoin: 1 hour
static const int64 nTargetSpacing = 30;						// Birdcoin: 30 sec
static const int64 nInterval = nTargetTimespan / nTargetSpacing;
static const int64 nTargetTimespanRe = 60 * 60; // 60 Minutes
static const int64 nTargetSpacingRe = 30; // Birdcoin: 30 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
   ...
   if(fNewDifficultyProtocol) {
    ...
    // Birdcoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal birdcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Birdcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xca8373a8f0e8e5814904b530a5c32d7f4a7ea48341029109289d7b02dba0db73");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "flappy bird ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1393220532;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2831156;
        ...
        assert(block.hashMerkleRoot == uint256("0xd9e9fb54b1a5e3cdfe0ff77ccb91ed62e609aecf67f5cfa3d5fc1d60cf6b788a"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Birdcoin: increase each by adding 2 to bitcoin's value.
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Birdcoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
